    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">Monthly sale{{info.sellCount}}one</span>
          <span class="shop-message-detail">
            {{info.description}}
            <span>make an appointment{{info.deliveryTime}}minute</span>
          </span>
          <span class="shop-message-detail">distance{{info.distance}}</span>
        </div>
      </div>
    </div>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          <h2 class="content-title">
            <span class="content-tag">
              <span class="mini-tag">brandand</span>
            </span>
            <span class="content-name">{{info.name}}</span>
          </h2>
    ...
    <transition name="fade">
      <div class="activity-sheet"  v-show="supportShow">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">Promotions</h2>
          <ul class="list">
