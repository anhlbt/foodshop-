  ...
  <section class="loginContainer">
    <div class="loginInner">
      <div class="login_header">
        <h2 class="login_logo">Canye takeaway</h2>
        <div class="login_header_title">
          <a href="javascript:;" :class="{on: loginWay}" @click="loginWay=true">SMS loginlogin</a>
          <a href="javascript:;" :class="{on: !loginWay}" @click="loginWay=false">Password login</a>
        </div>
      </div>
        ...
        <form>
          ...
          <div :class="{on: loginWay}">
            ...
            <section class="login_hint">
              Reminder: If you have not registered the mobile phone number of the Canye takeaway account, it will be automatically registered when you log in, and the representative has agreed
              <a href="javascript:;">"User Services Agreement"</a>
            </section>
          </div>
          <!-- 密码登陆 -->
          <div :class="{on: !loginWay}">
            <section>
              <section class="login_message">
                <input type="text" maxlength="11" placeholder="Mobile phone/email/user name" v-model="name">
              </section>
              <section class="login_verification">
                <!-- 是否显示密码 -->
                ...
                <div class="switch_button off" :class="showPwd?'on':'off'" @click="showPwd=!showPwd">
                  ...
                  <span class="switch_text">{{showPwd ? 'show' : 'hide'}}</span>
                </div>
              </section>
              <section class="login_message">
          ...
          <button class="login_submit" @click.prevent="login">Log in</button>
        </form>
