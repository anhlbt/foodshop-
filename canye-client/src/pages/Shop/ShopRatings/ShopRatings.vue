    ...
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left">
          ...
          <div class="rank">Higher than surrounding businesses{{info.rankRate}}%</div>
        </div>
        <div class="overview-right">
          ...
          <div class="score-wrapper">
            <span class="title">Commodity Rating</span>
            <Star :score="info.foodScore" :size="36" />
            <span class="score">{{info.foodScore}}</span>
          </div>
          <div class="delivery-wrapper">
            <span class="title">delivery time</span>
            <span class="delivery">{{info.deliveryTime}}minute</span>
          </div>
        </div>
      </div>
          ...
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                ...
                <span class="delivery">delivery time{{rating.deliveryTime||'0'}}minute</span>
              </div>
